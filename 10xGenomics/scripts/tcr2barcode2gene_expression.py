...
"""
    ...
    third, you should have barcodes.tsv.gz file which is generated by cellranger counts under filtered_feature_bc_matrix folder.
"""
tcr_list = sys.argv[1]
...
'''
for clonotype in clonotype2barcode_dict:
    barcodes = set(clonotype2barcode_dict[clonotype])
    ...
    for line in f:
        ...
        if tcr_id_fix in clonotype2barcode_dict:
            for barcode in set(clonotype2barcode_dict[tcr_id_fix]):
                ...
                '''
                if barcode in total_barcode_list:
                    print("{},{},{}".format(barcode, tcr_id, CFS))
                else:
                    not_found.append("{}_{}".format(barcode,tcr_id))
                '''
