...
setwd("/cygene2/work/P0000-Blackbird/2103-RA001/RA001004/shared_TCR_in_PBL_and_TILs_G175E1E2E5_G176E1_dsy")
getwd()
list.files()
############### for windows Rstudio.
...
print(length(args))
print(args)
args = c("G175E1L1_clonotypes_add_consensus_annotations.csv",
         "G175E2L1_clonotypes_add_consensus_annotations.csv",
         "G175E5L1_clonotypes_add_consensus_annotations.csv",
         "G176E1L1_clonotypes_add_consensus_annotations.csv")

file_list <- lapply(args, function(x) {
