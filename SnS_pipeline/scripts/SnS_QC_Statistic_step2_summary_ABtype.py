...
def _argparse():
    ...
    parser.add_argument('-u', '--umi',      action='store', type=int, dest="umi", help="umi number if you have")
...
def main():
    ...
    if parser.umi:
        umi = parser.umi
        print("(1) For all following samples. we used reads/UMI >= {} as the cutoff. I have looked through all reads/UMI distribution histograms. the choice of {} works well.".format(umi, umi))
