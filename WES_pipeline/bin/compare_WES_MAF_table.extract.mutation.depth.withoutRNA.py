...
for index, row in data.iterrows():
    ...
    if Position_start in mpileup_dict1:
        ...
        print("position start not in mpileup dict 1. please check! :{} {} {}".format(row['Hugo_Symbol'],row["Chromosome"],row["Start_Position"]))
    ...
    if Position_start in mpileup_dict2:
        ...
        print("position start not in mpileup dict 2. please check! :{} {} {}".format(row['Hugo_Symbol'],row["Chromosome"],row["Start_Position"]))
    ...
    output_file.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(
        ...
        # row["MutatedReads(RNA)"],row["MutatedReads(RNA)"],row["TPM"],
