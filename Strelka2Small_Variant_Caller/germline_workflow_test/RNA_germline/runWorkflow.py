#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/cygene/software/biosoftware/strelka/strelka-2.9.10.centos6_x86_64//bin/configureStrelkaGermlineWorkflow.py --bam /cygene2/work/P0000-Blackbird/2103-BL001/BL001004/BL001004_WES_RNAseq/BL001004/BL001004.RNA.Aligned.sortedByCoord.out.bam --referenceFasta /cygene/database/GATK_resource_bundle/hg38/Homo_sapiens_assembly38.fasta --runDir RNA_germline'
#
...
main(r"/cygene/work/00.test/pipeline/Strelka2Small_Variant_Caller/germline_workflow_test/RNA_germline/runWorkflow.py.config.pickle","StrelkaGermline",StrelkaGermlineWorkflow)
