#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/cygene/software/biosoftware/strelka/strelka-2.9.10.centos6_x86_64//bin/configureStrelkaSomaticWorkflow.py --normalBam /cygene2/work/P0000-Blackbird/2103-BL001/BL001004/BL001004_WES_RNAseq/BL001004/BL001004.Normal.duplicates_marked_sorted_fixed.BQSR.bam --tumorBam /cygene2/work/P0000-Blackbird/2103-BL001/BL001004/BL001004_WES_RNAseq/BL001004/BL001004.Tumor.duplicates_marked_sorted_fixed.BQSR.bam --referenceFasta /cygene/database/GATK_resource_bundle/hg38/Homo_sapiens_assembly38.fasta --runDir strelka_somatic_result --indelCandidates ./manta_results/results/variants/candidateSmallIndels.vcf.gz --exome --callRegions Regions_hg38.bed.gz'
#
...
sys.path.append(r'/cygene/software/biosoftware/strelka/strelka-2.9.10.centos6_x86_64/lib/python')
...
main(r"/cygene/work/00.test/pipeline/Strelka2Small_Variant_Caller/somatic_workflow_test/strelka_somatic_result/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
