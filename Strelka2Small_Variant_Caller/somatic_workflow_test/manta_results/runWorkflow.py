#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/cygene/software/biosoftware/manta/bin/configManta.py --normalBam /cygene2/work/P0000-Blackbird/2103-BL001/BL001004/BL001004_WES_RNAseq/BL001004/BL001004.Normal.duplicates_marked_sorted_fixed.BQSR.bam --tumorBam /cygene2/work/P0000-Blackbird/2103-BL001/BL001004/BL001004_WES_RNAseq/BL001004/BL001004.Tumor.duplicates_marked_sorted_fixed.BQSR.bam --referenceFasta /cygene/database/GATK_resource_bundle/hg38/Homo_sapiens_assembly38.fasta --runDir ./manta_results'
#
...
sys.path.append(r'/cygene/software/biosoftware/manta/lib/python')
...
main(r"/cygene/work/00.test/pipeline/Strelka2Small_Variant_Caller/somatic_workflow_test/manta_results/runWorkflow.py.config.pickle","manta",MantaWorkflow)
